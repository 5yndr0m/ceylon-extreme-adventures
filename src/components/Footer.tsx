      ...
      <footer>
        <div className='container'>
          <div className='footer-grid'>
            ...
            <div className='footer-col'>
              <h4>Experiences</h4>
              <Link href='/experiences?category=Abseiling'>Abseiling</Link>
              <Link href='/experiences?category=Hiking'>Hiking</Link>
              <Link href='/experiences?category=Camping%20%26%20Trekking'>Trekking and Camping</Link>
              <Link href='/experiences?category=Rafting'>Rafting</Link>
